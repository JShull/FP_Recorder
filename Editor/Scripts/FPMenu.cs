...
namespace FuzzPhyte.Recorder.Editor
{
    public class FPMenu : MonoBehaviour
    {
        ...
        [MenuItem("Window/FuzzPhyte/FP_Recorder/CreateRecorder", priority = FP_UtilityData.ORDER_SUBMENU_LVL1)]
        static protected void GenerateRecorder()
        {
            ...
            string assetPath = AssetDatabase.GenerateUniqueAssetPath(folderPath + "/ARecorder.asset");
